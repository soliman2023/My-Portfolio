...
const PersonalData = {
  name: "Mostafa A. Soliman",
  location: "name",
  Job: "FULL-STACK DEVELOPER, & SOFTWARE TESTER",
  summary:
  ...
  image: "src/assets/Imgs/MyImg/",
};
import personalImage from "../assets/Imgs/MyImg/MyHeadPic1.png"
const CVPages = [
  "src/assets/Imgs/CV/1.webp",
  "src/assets/Imgs/CV/2.webp",
  "src/assets/Imgs/CV/3.webp",
  "src/assets/Imgs/CV/4.webp",
];
let Skills = [
  {
    name: "",
  ...
  return (
    <div className="hero container mx-auto min-h-screen ">
      <div className="flex flex-col-reverse lg:flex-row">
        <div style={{marginLeft: '5%'}} className="lg:flex-1 content-center" >
        ...
        <div className="lg:flex-1 relative">
          <div className=" w-2/4   pt-0 lg:pt-10 m-auto card bg-theme-cc shadow-xl items-center my-10 lg:mb-0">
            <img style={{width: '80%'}} src={personalImage} alt={personalImage} className="mask mask-circle   shadow-3xl  shadow-black " />

            <div style={{backgroundColor: "steelblue"}} className=" badge bg-theme-p w-max text-lg font-semibold p-5 relative -top-10 text-white" >Software Engineer</div>
